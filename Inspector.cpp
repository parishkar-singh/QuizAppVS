...
namespace Inspector {
	namespace Diagnose {
		void validateSchemaAndTables() {
			...
			Validator::validateUserTable();
			Validator::validateGeographyTable();
			Validator::validateComputerScienceTable();
			Validator::validateHistoryTable();
			Validator::validateQuestionsSetTable();
			Validator::validateResultTable();
		}
	}
	namespace Validator {
